...
const mockPosts = [
  {
    ...
    username: "FroggyUser",
    handle: "froggyuser",
    content: "Working on some exciting updates for our pond community! Stay tuned for what's hopping next 🐸",
    timestamp: "3h ago",
    likes: 42,
    comments: 12,
    shares: 5,
  ...
  },
  {
    ...
    username: "FroggyUser",
    handle: "froggyuser",
    content: "Just completed my first web project using React! The pond's getting more digital every day 🌐",
    timestamp: "1d ago",
    likes: 89,
    comments: 34,
    shares: 12,
  ...
  },
  {
    ...
    username: "FroggyUser",
    handle: "froggyuser",
    content: "Design inspiration from nature - check out these amazing patterns! 🎨",
    timestamp: "2d ago",
    likes: 156,
    comments: 42,
    shares: 15,
