...
export const PostCard = ({
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in border border-primary/10">
